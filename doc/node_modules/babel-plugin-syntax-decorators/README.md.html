...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/babel-plugin-syntax-decorators/README.md";
...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h1">
        <a href="#babel-plugin-syntax-decorators">babel-plugin-syntax-decorators</a>
      </div>
  ...
  <div id="container">
    <div class="docs markdown"><div class="pilwrap" id="babel-plugin-syntax-decorators">
  <h1>
    <a href="#babel-plugin-syntax-decorators" name="babel-plugin-syntax-decorators" class="pilcrow"></a>
...
<pre><code class="sh">$ npm install babel-plugin-syntax-decorators
</code></pre>
...
<pre><code class="json">{
  <span class="hljs-attr">"plugins"</span>: [<span class="hljs-string">"syntax-decorators"</span>]
}
</code></pre>
...
<pre><code class="sh">$ babel --plugins syntax-decorators script.js
</code></pre>
