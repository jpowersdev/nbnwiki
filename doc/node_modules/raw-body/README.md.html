...
app.use(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">req, res, next</span>) </span>{
  getRawBody(req, {
    ...
    <span class="hljs-attr">encoding</span>: typer.parse(req.headers[<span class="hljs-string">'content-type'</span>]).parameters.charset
...
<pre><code class="js">app.use(<span class="hljs-function"><span class="hljs-keyword">function</span>* (<span class="hljs-params">next</span>) </span>{
  <span class="hljs-keyword">var</span> string = <span class="hljs-keyword">yield</span> getRawBody(<span class="hljs-keyword">this</span>.req, {
    ...
    <span class="hljs-attr">limit</span>: <span class="hljs-string">'1mb'</span>,
    <span class="hljs-attr">encoding</span>: <span class="hljs-keyword">this</span>.charset
  })
})
</code></pre>
