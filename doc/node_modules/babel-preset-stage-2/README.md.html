...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/babel-preset-stage-2/README.md";
...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h1">
        <a href="#babel-preset-stage-2">babel-preset-stage-2</a>
      </div>
  ...
  <div id="container">
    <div class="docs markdown"><div class="pilwrap" id="babel-preset-stage-2">
  <h1>
    <a href="#babel-preset-stage-2" name="babel-preset-stage-2" class="pilcrow"></a>
babel-preset-stage-2
  </h1>
</div>
<blockquote>
<p>Babel preset for stage 2 plugins.</p>
</blockquote>
...
<pre><code class="sh">npm install --save-dev babel-preset-stage-2
</code></pre>
...
<pre><code class="json">{
  <span class="hljs-attr">"presets"</span>: [<span class="hljs-string">"stage-2"</span>]
}
</code></pre>
...
<pre><code class="sh">babel script.js --presets stage-2
</code></pre>
