...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/babel-plugin-syntax-flow/README.md";
...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h1">
        <a href="#babel-plugin-syntax-flow">babel-plugin-syntax-flow</a>
      </div>
  ...
  <div id="container">
    <div class="docs markdown"><div class="pilwrap" id="babel-plugin-syntax-flow">
  <h1>
...
<pre><code class="sh">$ npm install babel-plugin-syntax-flow
</code></pre>
...
<pre><code class="json">{
  <span class="hljs-attr">"plugins"</span>: [<span class="hljs-string">"syntax-flow"</span>]
}
</code></pre>
...
<pre><code class="sh">$ babel --plugins syntax-flow script.js
</code></pre>
