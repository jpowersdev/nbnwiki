...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/indent-string/cli.js";
...
<span class="hljs-keyword">var</span> indentString = <span class="hljs-built_in">require</span>(<span class="hljs-string">'./'</span>);
<span class="hljs-keyword">var</span> input = argv._;
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">help</span>(<span class="hljs-params"></span>) </span>{
	<span class="hljs-built_in">console</span>.log([
		...
		<span class="hljs-string">'  '</span> + pkg.description,
		<span class="hljs-string">''</span>,
		<span class="hljs-string">'  Usage'</span>,
		<span class="hljs-string">'    indent-string &lt;string&gt; [--indent &lt;string&gt;] [--count &lt;number&gt;]'</span>,
		<span class="hljs-string">'    cat file.txt | indent-string &gt; indented-file.txt'</span>,
		<span class="hljs-string">''</span>,
		<span class="hljs-string">'  Example'</span>,
		<span class="hljs-string">'    indent-string "$(printf \'Unicorns\\nRainbows\\n\')" --indent ♥ --count 4'</span>,
		<span class="hljs-string">'    ♥♥♥♥Unicorns'</span>,
		<span class="hljs-string">'    ♥♥♥♥Rainbows'</span>
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">init</span>(<span class="hljs-params">data</span>) </span>{
	<span class="hljs-built_in">console</span>.log(indentString(data, argv.indent || <span class="hljs-string">' '</span>, argv.count));
}
...
<span class="hljs-keyword">if</span> (process.stdin.isTTY) {
	...
	init(input[<span class="hljs-number">0</span>]);
