...
<p>even if its not own property I'd still call it non-empty</p>
...
<span class="hljs-keyword">var</span> some$<span class="hljs-number">1</span> = some;
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">isValid</span>(<span class="hljs-params">m</span>) </span>{
    <span class="hljs-keyword">if</span> (m._isValid == <span class="hljs-literal">null</span>) {
        ...
        <span class="hljs-keyword">var</span> parsedParts = some$<span class="hljs-number">1.</span>call(flags.parsedDateParts, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">i</span>) </span>{
...
<span class="hljs-keyword">var</span> keys$<span class="hljs-number">1</span> = keys;
...
includes scottish gaelic two word and hyphenated months</p>
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">var</span> matchWord = <span class="hljs-regexp">/[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i</span>;
...
<span class="hljs-keyword">var</span> indexOf$<span class="hljs-number">1</span> = indexOf;
...
<p>this is not used</p>
    ...
    <span class="hljs-keyword">if</span> (strict) {
        <span class="hljs-keyword">if</span> (format === <span class="hljs-string">'MMM'</span>) {
            ii = indexOf$<span class="hljs-number">1.</span>call(<span class="hljs-keyword">this</span>._shortMonthsParse, llc);
            <span class="hljs-keyword">return</span> ii !== <span class="hljs-number">-1</span> ? ii : <span class="hljs-literal">null</span>;
        } <span class="hljs-keyword">else</span> {
            ii = indexOf$<span class="hljs-number">1.</span>call(<span class="hljs-keyword">this</span>._longMonthsParse, llc);
            <span class="hljs-keyword">return</span> ii !== <span class="hljs-number">-1</span> ? ii : <span class="hljs-literal">null</span>;
        }
    } <span class="hljs-keyword">else</span> {
        <span class="hljs-keyword">if</span> (format === <span class="hljs-string">'MMM'</span>) {
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">handleStrictParse$1</span>(<span class="hljs-params">weekdayName, format, strict</span>) </span>{
    ...
    <span class="hljs-keyword">if</span> (strict) {
        <span class="hljs-keyword">if</span> (format === <span class="hljs-string">'dddd'</span>) {
            ii = indexOf$<span class="hljs-number">1.</span>call(<span class="hljs-keyword">this</span>._weekdaysParse, llc);
            <span class="hljs-keyword">return</span> ii !== <span class="hljs-number">-1</span> ? ii : <span class="hljs-literal">null</span>;
        } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (format === <span class="hljs-string">'ddd'</span>) {
            ii = indexOf$<span class="hljs-number">1.</span>call(<span class="hljs-keyword">this</span>._shortWeekdaysParse, llc);
            <span class="hljs-keyword">return</span> ii !== <span class="hljs-number">-1</span> ? ii : <span class="hljs-literal">null</span>;
        } <span class="hljs-keyword">else</span> {
            ii = indexOf$<span class="hljs-number">1.</span>call(<span class="hljs-keyword">this</span>._minWeekdaysParse, llc);
            <span class="hljs-keyword">return</span> ii !== <span class="hljs-number">-1</span> ? ii : <span class="hljs-literal">null</span>;
        }
    } <span class="hljs-keyword">else</span> {
        <span class="hljs-keyword">if</span> (format === <span class="hljs-string">'dddd'</span>) {
...
meridiem</p>
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">var</span> baseConfig = {
...
<p>TODO: Find a better way to register and load all the locales in Node</p>
        ...
        <span class="hljs-keyword">try</span> {
            ...
            <span class="hljs-built_in">require</span>(<span class="hljs-string">'./locale/'</span> + name);
</pre>
        </td>
      </tr>
...
want to undo that for lazy loaded locales</p>
        ...
        <td class="code highlight">
          <pre class="javascript">            getSetGlobalLocale(oldLocale);
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">defineLocale</span> (<span class="hljs-params">name, config</span>) </span>{
    <span class="hljs-keyword">if</span> (config !== <span class="hljs-literal">null</span>) {
        <span class="hljs-keyword">var</span> parentConfig = baseConfig;
        config.abbr = name;
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">listLocales</span>(<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">return</span> keys$<span class="hljs-number">1</span>(locales);
}
...
<p>RFC 2822 regex: For details see https://tools.ietf.org/html/rfc2822#section-3.3</p>
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">var</span> basicRfcRegex = <span class="hljs-regexp">/^((?:Mon|Tue|Wed|Thu|Fri|Sat|Sun),?\s)?(\d?\d\s(?:Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\s(?:\d\d)?\d\d\s)(\d\d:\d\d)(\:\d\d)?(\s(?:UT|GMT|[ECMP][SD]T|[A-IK-Za-ik-z]|[+-]\d{4}))$/</span>;
...
<p>date and time from ref 2822 format</p>
    ...
    <span class="hljs-keyword">var</span> string, match, dayFormat,
        dateFormat, timeFormat, tzFormat;
    <span class="hljs-keyword">var</span> timezones = {
        <span class="hljs-string">' GMT'</span>: <span class="hljs-string">' +0000'</span>,
        <span class="hljs-string">' EDT'</span>: <span class="hljs-string">' -0400'</span>,
        <span class="hljs-string">' EST'</span>: <span class="hljs-string">' -0500'</span>,
        <span class="hljs-string">' CDT'</span>: <span class="hljs-string">' -0500'</span>,
        <span class="hljs-string">' CST'</span>: <span class="hljs-string">' -0600'</span>,
        <span class="hljs-string">' MDT'</span>: <span class="hljs-string">' -0600'</span>,
        <span class="hljs-string">' MST'</span>: <span class="hljs-string">' -0700'</span>,
        <span class="hljs-string">' PDT'</span>: <span class="hljs-string">' -0700'</span>,
        <span class="hljs-string">' PST'</span>: <span class="hljs-string">' -0800'</span>
    };
    <span class="hljs-keyword">var</span> military = <span class="hljs-string">'YXWVUTSRQPONZABCDEFGHIKLM'</span>;
    <span class="hljs-keyword">var</span> timezone, timezoneIndex;

    string = config._i
        .replace(<span class="hljs-regexp">/\([^\)]*\)|[\n\t]/g</span>, <span class="hljs-string">' '</span>) <span class="hljs-comment">// Remove comments and folding whitespace</span>
        .replace(<span class="hljs-regexp">/(\s\s+)/g</span>, <span class="hljs-string">' '</span>) <span class="hljs-comment">// Replace multiple-spaces with a single space</span>
        .replace(<span class="hljs-regexp">/^\s|\s$/g</span>, <span class="hljs-string">''</span>); <span class="hljs-comment">// Remove leading and trailing spaces</span>
    match = basicRfcRegex.exec(string);

    <span class="hljs-keyword">if</span> (match) {
        dayFormat = match[<span class="hljs-number">1</span>] ? <span class="hljs-string">'ddd'</span> + ((match[<span class="hljs-number">1</span>].length === <span class="hljs-number">5</span>) ? <span class="hljs-string">', '</span> : <span class="hljs-string">' '</span>) : <span class="hljs-string">''</span>;
        dateFormat = <span class="hljs-string">'D MMM '</span> + ((match[<span class="hljs-number">2</span>].length &gt; <span class="hljs-number">10</span>) ? <span class="hljs-string">'YYYY '</span> : <span class="hljs-string">'YY '</span>);
        timeFormat = <span class="hljs-string">'HH:mm'</span> + (match[<span class="hljs-number">4</span>] ? <span class="hljs-string">':ss'</span> : <span class="hljs-string">''</span>);
...
<p>TODO: Replace the vanilla JS Date object with an indepentent day-of-week check.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">        <span class="hljs-keyword">if</span> (match[<span class="hljs-number">1</span>]) { <span class="hljs-comment">// day of week given</span>
            <span class="hljs-keyword">var</span> momentDate = <span class="hljs-keyword">new</span> <span class="hljs-built_in">Date</span>(match[<span class="hljs-number">2</span>]);
            <span class="hljs-keyword">var</span> momentDay = [<span class="hljs-string">'Sun'</span>,<span class="hljs-string">'Mon'</span>,<span class="hljs-string">'Tue'</span>,<span class="hljs-string">'Wed'</span>,<span class="hljs-string">'Thu'</span>,<span class="hljs-string">'Fri'</span>,<span class="hljs-string">'Sat'</span>][momentDate.getDay()];

            <span class="hljs-keyword">if</span> (match[<span class="hljs-number">1</span>].substr(<span class="hljs-number">0</span>,<span class="hljs-number">3</span>) !== momentDay) {
        ...
        <span class="hljs-keyword">switch</span> (match[<span class="hljs-number">5</span>].length) {
            <span class="hljs-keyword">case</span> <span class="hljs-number">2</span>: <span class="hljs-comment">// military</span>
                <span class="hljs-keyword">if</span> (timezoneIndex === <span class="hljs-number">0</span>) {
                    timezone = <span class="hljs-string">' +0000'</span>;
                } <span class="hljs-keyword">else</span> {
                    timezoneIndex = military.indexOf(match[<span class="hljs-number">5</span>][<span class="hljs-number">1</span>].toUpperCase()) - <span class="hljs-number">12</span>;
                    timezone = ((timezoneIndex &lt; <span class="hljs-number">0</span>) ? <span class="hljs-string">' -'</span> : <span class="hljs-string">' +'</span>) +
                        ((<span class="hljs-string">''</span> + timezoneIndex).replace(<span class="hljs-regexp">/^-?/</span>, <span class="hljs-string">'0'</span>)).match(<span class="hljs-regexp">/..$/</span>)[<span class="hljs-number">0</span>] + <span class="hljs-string">'00'</span>;
                }
                <span class="hljs-keyword">break</span>;
            <span class="hljs-keyword">case</span> <span class="hljs-number">4</span>: <span class="hljs-comment">// Zone</span>
                timezone = timezones[match[<span class="hljs-number">5</span>]];
                <span class="hljs-keyword">break</span>;
            <span class="hljs-keyword">default</span>: <span class="hljs-comment">// UT or +/-9999</span>
                timezone = timezones[<span class="hljs-string">' GMT'</span>];
        }
        match[<span class="hljs-number">5</span>] = timezone;
        config._i = match.splice(<span class="hljs-number">1</span>).join(<span class="hljs-string">''</span>);
        tzFormat = <span class="hljs-string">' ZZ'</span>;
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">isDurationValid</span>(<span class="hljs-params">m</span>) </span>{
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> key <span class="hljs-keyword">in</span> m) {
        <span class="hljs-keyword">if</span> (!(ordering.indexOf(key) !== <span class="hljs-number">-1</span> &amp;&amp; (m[key] == <span class="hljs-literal">null</span> || !<span class="hljs-built_in">isNaN</span>(m[key])))) {
            <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>;
        }
    }
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">toISOString</span>(<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">if</span> (!<span class="hljs-keyword">this</span>.isValid()) {
        <span class="hljs-keyword">return</span> <span class="hljs-literal">null</span>;
    }
...
<p>native implementation is ~50x faster, use it when we can</p>
        ...
        <td class="code highlight">
          <pre class="javascript">        <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.toDate().toISOString();
    }
...
<p>Year</p>
        ...
        <td class="code highlight">
          <pre class="javascript">proto.year       = getSetYear;
...
<p>Week Year</p>
        ...
        <td class="code highlight">
          <pre class="javascript">proto.weekYear    = getSetWeekYear;
...
<p>Quarter</p>
        ...
        <td class="code highlight">
          <pre class="javascript">proto.quarter = proto.quarters = getSetQuarter;
...
<p>Month</p>
        ...
        <td class="code highlight">
          <pre class="javascript">proto.month       = getSetMonth;
...
<p>Week</p>
        ...
        <td class="code highlight">
          <pre class="javascript">proto.week           = proto.weeks        = getSetWeek;
...
<p>Day</p>
        ...
        <td class="code highlight">
          <pre class="javascript">proto.date       = getSetDayOfMonth;
...
<p>Hour</p>
        ...
        <td class="code highlight">
          <pre class="javascript">proto.hour = proto.hours = getSetHour;
...
<p>Minute</p>
        ...
        <td class="code highlight">
          <pre class="javascript">proto.minute = proto.minutes = getSetMinute;
...
<p>Second</p>
        ...
        <td class="code highlight">
          <pre class="javascript">proto.second = proto.seconds = getSetSecond;
...
<p>Millisecond</p>
        ...
        <td class="code highlight">
          <pre class="javascript">proto.millisecond = proto.milliseconds = getSetMillisecond;
...
<p>Offset</p>
        ...
        <td class="code highlight">
          <pre class="javascript">proto.utcOffset            = getSetOffset;
...
<p>Timezone</p>
        ...
        <td class="code highlight">
          <pre class="javascript">proto.zoneAbbr = getZoneAbbr;
...
<p>Deprecations</p>
        ...
        <td class="code highlight">
          <pre class="javascript">proto.dates  = deprecate(<span class="hljs-string">'dates accessor is deprecated. Use date instead.'</span>, getSetDayOfMonth);
...
<p>Month</p>
        ...
        <td class="code highlight">
          <pre class="javascript">proto$<span class="hljs-number">1.</span>months            =        localeMonths;
...
<p>Week</p>
        ...
        <td class="code highlight">
          <pre class="javascript">proto$<span class="hljs-number">1.</span>week = localeWeek;
...
<p>Day of Week</p>
        ...
        <td class="code highlight">
          <pre class="javascript">proto$<span class="hljs-number">1.</span>weekdays       =        localeWeekdays;
...
<p>Hours</p>
        ...
        <td class="code highlight">
          <pre class="javascript">proto$<span class="hljs-number">1.</span>isPM = localeIsPM;
...
<p>Side effect imports</p>
        ...
        <td class="code highlight">
          <pre class="javascript">hooks.lang = deprecate(<span class="hljs-string">'moment.lang is deprecated. Use moment.locale instead.'</span>, getSetGlobalLocale);
...
<p>Deprecations</p>
        ...
        <td class="code highlight">
          <pre class="javascript">proto$<span class="hljs-number">2.</span>toIsoString = deprecate(<span class="hljs-string">'toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)'</span>, toISOString$<span class="hljs-number">1</span>);
...
hooks.version = <span class="hljs-string">'2.18.0'</span>;
