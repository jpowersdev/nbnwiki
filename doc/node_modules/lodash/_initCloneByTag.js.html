...
<table cellpadding="0" cellspacing="0">
  ...
  <a class="pilcrow" href="#section-1" id="section-1"></a>
    ...
    cloneMap = <span class="hljs-built_in">require</span>(<span class="hljs-string">'./_cloneMap'</span>),
    cloneRegExp = <span class="hljs-built_in">require</span>(<span class="hljs-string">'./_cloneRegExp'</span>),
    cloneSet = <span class="hljs-built_in">require</span>(<span class="hljs-string">'./_cloneSet'</span>),
...
<span>Specify a deep clone.
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">initCloneByTag</span>(<span class="hljs-params">object, tag, cloneFunc, isDeep</span>) </span>{
  ...
  <span class="hljs-keyword">switch</span> (tag) {
    ...
    <span class="hljs-keyword">case</span> mapTag:
      <span class="hljs-keyword">return</span> cloneMap(object, isDeep, cloneFunc);
    ...
    <span class="hljs-keyword">case</span> setTag:
      <span class="hljs-keyword">return</span> cloneSet(object, isDeep, cloneFunc);
