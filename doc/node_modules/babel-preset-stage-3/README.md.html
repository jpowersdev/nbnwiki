...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/babel-preset-stage-3/README.md";
...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h1">
        <a href="#babel-preset-stage-3">babel-preset-stage-3</a>
      </div>
  ...
  <div id="container">
    <div class="docs markdown"><div class="pilwrap" id="babel-preset-stage-3">
  <h1>
    <a href="#babel-preset-stage-3" name="babel-preset-stage-3" class="pilcrow"></a>
babel-preset-stage-3
  </h1>
</div>
<blockquote>
<p>Babel preset for stage 3 plugins.</p>
</blockquote>
...
<pre><code class="sh">npm install --save-dev babel-preset-stage-3
</code></pre>
...
<pre><code class="json">{
  <span class="hljs-attr">"presets"</span>: [<span class="hljs-string">"stage-3"</span>]
}
</code></pre>
...
<pre><code class="sh">babel script.js --presets stage-3
</code></pre>
