...
<span class="hljs-keyword">template</span> &lt;<span class="hljs-keyword">typename</span> T&gt; <span class="hljs-keyword">inline</span> v8::Local&lt;T&gt; New(v8::Handle&lt;T&gt; h);
...
<span class="hljs-keyword">template</span> &lt;<span class="hljs-keyword">typename</span> T&gt; <span class="hljs-keyword">inline</span> v8::Local&lt;T&gt; New(v8::Persistent&lt;T&gt; <span class="hljs-keyword">const</span>&amp; p);
<span class="hljs-meta">#<span class="hljs-meta-keyword">endif</span></span>
<span class="hljs-keyword">template</span> &lt;<span class="hljs-keyword">typename</span> T, <span class="hljs-keyword">typename</span> M&gt;
...
imp::Factory&lt;v8::Boolean&gt;::<span class="hljs-keyword">return_t</span>
New(<span class="hljs-keyword">bool</span> value) {
  <span class="hljs-keyword">return</span> New&lt;v8::Boolean&gt;(value);
}

<span class="hljs-keyword">inline</span>
imp::Factory&lt;v8::Int32&gt;::<span class="hljs-keyword">return_t</span>
New(<span class="hljs-keyword">int32_t</span> value) {
  <span class="hljs-keyword">return</span> New&lt;v8::Int32&gt;(value);
}

<span class="hljs-keyword">inline</span>
imp::Factory&lt;v8::Uint32&gt;::<span class="hljs-keyword">return_t</span>
New(<span class="hljs-keyword">uint32_t</span> value) {
  <span class="hljs-keyword">return</span> New&lt;v8::Uint32&gt;(value);
}

<span class="hljs-keyword">inline</span>
imp::Factory&lt;v8::Number&gt;::<span class="hljs-keyword">return_t</span>
New(<span class="hljs-keyword">double</span> value) {
  <span class="hljs-keyword">return</span> New&lt;v8::Number&gt;(value);
}

<span class="hljs-keyword">inline</span>
imp::Factory&lt;v8::String&gt;::<span class="hljs-keyword">return_t</span>
New(<span class="hljs-built_in">std</span>::<span class="hljs-built_in">string</span> <span class="hljs-keyword">const</span>&amp; value) {  <span class="hljs-comment">// NOLINT(build/include_what_you_use)</span>
  <span class="hljs-keyword">return</span> New&lt;v8::String&gt;(value);
}

<span class="hljs-keyword">inline</span>
imp::Factory&lt;v8::String&gt;::<span class="hljs-keyword">return_t</span>
New(<span class="hljs-keyword">const</span> <span class="hljs-keyword">char</span> * value, <span class="hljs-keyword">int</span> length) {
  <span class="hljs-keyword">return</span> New&lt;v8::String&gt;(value, length);
}

<span class="hljs-keyword">inline</span>
imp::Factory&lt;v8::String&gt;::<span class="hljs-keyword">return_t</span>
New(<span class="hljs-keyword">const</span> <span class="hljs-keyword">uint16_t</span> * value, <span class="hljs-keyword">int</span> length) {
  <span class="hljs-keyword">return</span> New&lt;v8::String&gt;(value, length);
}

<span class="hljs-keyword">inline</span>
imp::Factory&lt;v8::String&gt;::<span class="hljs-keyword">return_t</span>
New(<span class="hljs-keyword">const</span> <span class="hljs-keyword">char</span> * value) {
  <span class="hljs-keyword">return</span> New&lt;v8::String&gt;(value);
}

<span class="hljs-keyword">inline</span>
imp::Factory&lt;v8::String&gt;::<span class="hljs-keyword">return_t</span>
New(<span class="hljs-keyword">const</span> <span class="hljs-keyword">uint16_t</span> * value) {
  <span class="hljs-keyword">return</span> New&lt;v8::String&gt;(value);
}
...
<span class="hljs-keyword">inline</span>
imp::Factory&lt;v8::RegExp&gt;::<span class="hljs-keyword">return_t</span>
New(v8::Local&lt;v8::String&gt; pattern, v8::RegExp::Flags flags) {
  <span class="hljs-keyword">return</span> New&lt;v8::RegExp&gt;(pattern, flags);
}

<span class="hljs-meta">#<span class="hljs-meta-keyword">endif</span>  <span class="hljs-comment">// NAN_NEW_H_</span></span>
