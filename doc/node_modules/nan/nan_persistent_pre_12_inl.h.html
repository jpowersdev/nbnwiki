...
<div class="body">
        ...
        <td class="code highlight">
          <pre class="c">  inline Global(RValue rvalue)
...
<div class="body">
  ...
  <span class="hljs-keyword">inline</span> Global &amp;<span class="hljs-keyword">operator</span>=(Global&lt;S&gt; rhs) {
    TYPE_CHECK(T, S);
...
<div class="body">
        ...
        <td class="code highlight">
          <pre class="c">  <span class="hljs-function"><span class="hljs-keyword">inline</span> <span class="hljs-keyword">operator</span> <span class="hljs-title">RValue</span><span class="hljs-params">()</span> </span>{ <span class="hljs-keyword">return</span> RValue(<span class="hljs-keyword">this</span>); }
</pre>
        </td>
      </tr>
