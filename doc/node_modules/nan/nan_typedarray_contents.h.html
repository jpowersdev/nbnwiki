...
<html>
<head>
  <title>nan_typedarray_contents.h</title>
  <meta http-equiv="content-type" content="text/html; charset=UTF-8">
  <link rel="stylesheet" media="all" href="../../doc-style.css" />
  <script src="../../doc-filelist.js"></script>
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/nan/nan_typedarray_contents.h";
...
<table cellpadding="0" cellspacing="0">
  <tbody>
      ...
      <tr>
        <td class="docs">
          <h1>nan_typedarray_contents.h</h1>
        </td>
...
<p>Disable heap allocation</p>

        </td>
        <td class="code highlight">
          <pre class="c">  <span class="hljs-function"><span class="hljs-keyword">void</span> *<span class="hljs-keyword">operator</span> <span class="hljs-title">new</span><span class="hljs-params">(<span class="hljs-keyword">size_t</span> size)</span></span>;
  ...
  <span class="hljs-keyword">size_t</span>  length_;
  T*      data_;
};

<span class="hljs-meta">#<span class="hljs-meta-keyword">endif</span>  <span class="hljs-comment">// NAN_TYPEDARRAY_CONTENTS_H_</span></span>
