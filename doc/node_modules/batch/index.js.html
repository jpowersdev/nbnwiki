...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/batch/index.js";
...
<p>empty</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">if</span> (!fns.length) <span class="hljs-keyword">return</span> cb(<span class="hljs-literal">null</span>, results);
...
<p>process</p>
    ...
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">callback</span>(<span class="hljs-params">err, res</span>)</span>{
      ...
      <span class="hljs-keyword">if</span> (err &amp;&amp; throws) <span class="hljs-keyword">return</span> done = <span class="hljs-literal">true</span>, cb(err);
      ...
      <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span>(!throws) cb(errors, results);
