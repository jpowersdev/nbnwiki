...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/kind-of/README.md";
...
<body>
  ...
  <div id="container">
    <div class="docs markdown"><div class="pilwrap" id="kind-of">
  <h1>
    <a href="#kind-of" name="kind-of" class="pilcrow"></a>
...
<pre><code class="js"><span class="hljs-keyword">var</span> kindOf = <span class="hljs-built_in">require</span>(<span class="hljs-string">'kind-of'</span>);
...
<pre><code class="bash"><span class="hljs-comment">#1: array</span>
...
<div class="pilwrap" id="optimizations">
  <h2>
    <a href="#optimizations" name="optimizations" class="pilcrow"></a>
Optimizations
  </h2>
</div>
...
<pre><code class="sh">$ npm install <span class="hljs-_">-d</span> &amp;&amp; npm <span class="hljs-built_in">test</span>
</code></pre>
