...
} <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> fs.access === <span class="hljs-string">'function'</span>) {
  core = <span class="hljs-built_in">require</span>(<span class="hljs-string">'./access.js'</span>)
