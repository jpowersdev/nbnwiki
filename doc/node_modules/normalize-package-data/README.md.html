...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/normalize-package-data/README.md";
...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h1">
        <a href="#normalize-package-data">normalize-package-data </a>
      </div>
      ...
      <div class="heading h3">
        <a href="#potential-exceptions">Potential exceptions</a>
      </div>

      <div class="heading h2">
        <a href="#what-normalization-currently-entails">What normalization (currently) entails</a>
      </div>

      <div class="heading h3">
        <a href="#rules-for-name-field">Rules for name field</a>
      </div>

      <div class="heading h3">
        <a href="#rules-for-version-field">Rules for version field</a>
      </div>

      <div class="heading h3">
        <a href="#rules-for-license-field">Rules for license field</a>
      </div>
  ...
  <div id="container">
    <div class="docs markdown"><div class="pilwrap" id="normalize-package-data">
  <h1>
    <a href="#normalize-package-data" name="normalize-package-data" class="pilcrow"></a>
normalize-package-data <a href="https://travis-ci.org/npm/normalize-package-data"><img src="https://travis-ci.org/npm/normalize-package-data.png?branch=master" alt="Build Status"></a>
  </h1>
</div>
...
<pre><code class="javascript">normalizeData = <span class="hljs-built_in">require</span>(<span class="hljs-string">'normalize-package-data'</span>)
...
<div class="pilwrap" id="strict-mode">
  <h4>
    <a href="#strict-mode" name="strict-mode" class="pilcrow"></a>
Strict mode
  </h4>
</div>
...
<div class="pilwrap" id="potential-exceptions">
  <h3>
    <a href="#potential-exceptions" name="potential-exceptions" class="pilcrow"></a>
...
<div class="pilwrap" id="what-normalization-currently-entails">
  <h2>
    <a href="#what-normalization-currently-entails" name="what-normalization-currently-entails" class="pilcrow"></a>
...
<div class="pilwrap" id="rules-for-name-field">
  <h3>
    <a href="#rules-for-name-field" name="rules-for-name-field" class="pilcrow"></a>
...
<div class="pilwrap" id="rules-for-version-field">
  <h3>
    <a href="#rules-for-version-field" name="rules-for-version-field" class="pilcrow"></a>
...
<div class="pilwrap" id="rules-for-license-field">
  <h3>
    <a href="#rules-for-license-field" name="rules-for-license-field" class="pilcrow"></a>
