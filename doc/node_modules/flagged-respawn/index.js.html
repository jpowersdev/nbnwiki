...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/flagged-respawn/index.js";
...
<table cellpadding="0" cellspacing="0">
  ...
  <a class="pilcrow" href="#section-1" id="section-1"></a>
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">const</span> reorder = <span class="hljs-built_in">require</span>(<span class="hljs-string">'./lib/reorder'</span>);
<span class="hljs-keyword">const</span> respawn = <span class="hljs-built_in">require</span>(<span class="hljs-string">'./lib/respawn'</span>);

<span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">flags, argv, execute</span>) </span>{
